...
const JobFlow = () => {
  ...
  const renderSummary = () => {
    ...
    return (
      <InspectionSummary
        job={summary.job || job}
        onEditReport={handleEditReportFromSummary}
        onSendReport={handleSendReportFromSummary}
      />
    );
  };
      ...
      <>
        ...
        <div className={styles.jobCard}>
          ...
          <div className={styles.section}>
            ...
            <p className={styles.sectionText}>{job?.customerSnapshot?.phone}</p>
          </div>
          <div className={styles.section}>
            <h3 className={styles.sectionTitle}>Vehicle</h3>
            <p className={styles.sectionContent}>
              {job?.vehicleSnapshot?.brand} {job?.vehicleSnapshot?.model}
            </p>
            <p className={styles.sectionText}>{job?.vehicleSnapshot?.year}</p>
          </div>
          <div className={styles.section}>
            <h3 className={styles.sectionTitle}>Location</h3>
            <p className={styles.sectionText}>{job?.location?.address}</p>
          </div>
            ...
            <button
              ...
              title={
                !allCheckpointsCompleted()
                  ? "Please complete all checkpoints before submitting"
                  : ""
              }
            >
              {actionLoading ? (
